...
- technical writer at **[FluxML](https://fluxml.ai/){:target="_blank"}**.
- **[research fellow](https://iris-hep.org/fellows/Saransh-cpp.html){:target="_blank"}** at the **[Analysis Systems](https://iris-hep.org/as.html){:target="_blank"}** group of **[Institute for Research and Innovation in Software for High Energy Physics](https://iris-hep.org/){:target="_blank"}**, **[Princeton University](https://www.princeton.edu/)**.
- **[Google Summer of Code](https://summerofcode.withgoogle.com/){:target="_blank"}** student developer under **[PyBaMM](https://www.pybamm.org/){:target="_blank"}** (Python Battery Mathematical Modeling), **[NumFOCUS](https://numfocus.org/){:target="_blank"}**..
