...
I am currently based at **[CERN](https://home.cern){:target="_blank"}**, working as a Research Fellow with the **[Princeton Research Computing Group](https://researchcomputing.princeton.edu){:target="_blank"}** and **[IRIS-HEP](https://researchcomputing.princeton.edu/research/iris-hep-software-institute){:target="_blank"}**. I graduated from the **[University of Delhi](http://du.ac.in/){:target="_blank"}** with a major in CS and Mathematics in 2024. In daylight, I work on my academic skills and professional commitments, and by night, I develop and maintain open-source scientific software (see **[/opensource](/opensource)**), which I believe are the key to collaborative and reproducible research.
